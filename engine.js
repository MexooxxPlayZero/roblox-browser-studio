{
  var setup = () => {
      ...
      <div class="ro-body">
        <div class="side-panel" id="side-panel">
          <div id="tab-av" class="t-pane">
            <label style="font-size:10px;color:#888">ADVANCED BODY COLORS</label>
            ...
            <button class="btn-ui" id="u-btn" style="width:100%;background:#0084ff">Load User Face</button>
          </div>
          <div id="tab-wd" class="t-pane hidden">
            <button class="btn-ui" id="btn-spawn" style="width:100%">Create Part</button>
          </div>
          <div id="tab-ed" class="t-pane hidden"><p style="color:#444">Empty Menu...</p></div>
        ...
        <div id="canvas-container">
          ...
          <div id="esc-menu">
            <div style="background:#222;padding:30px;border-radius:15px;display:flex;flex-direction:column;gap:10px;width:250px">
              <button class="btn-ui" id="esc-resume">Resume</button>
              <button class="btn-ui" id="esc-leave" style="background:#ff4b4b">Stop</button>
            </div>
          </div>
        </div>
      </div>`;
    ...
    document.getElementById('close-all').onclick = () => location.reload();
    ...
    var start = () => {
      ...
      // Advanced Color Selection Logic
      const colors = ['#f5f5f5','#1b1b1f','#ff0000','#00ff00','#0000ff','#ffff00','#ff00ff','#00ffff','#ff5500','#55ff00','#ffaa00','#aa55ff','#ffffff','#a3a2a5','#333333'];
