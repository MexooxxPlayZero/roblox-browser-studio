{
  var setup = () => {
    ...
    roWin.innerHTML = `
      <div class="ro-bar"><span>Roblox Studio v0.6.0</span><button style="margin-left:auto;background:#ff4b4b;border:none;color:#fff;cursor:pointer;border-radius:4px;padding:2px 10px" onclick="this.closest('.ro-win').remove()">X</button></div>
      <div class="ro-tabs">
      ...
      <div class="ro-body">
        <div class="side-panel" id="panel-avatar">
          <label style="font-size:10px;color:#888">PART COLORING</label>
          ...
          <button id="btn-save-prog" class="ro-btn-save">💾 SAVE PROGRESSION</button>
        ...
        <div class="side-panel hidden" id="panel-anim">
          ...
          <button class="ro-btn-blue anim-btn" data-anim="idle">IDLE</button>
          <button class="ro-btn-blue anim-btn" data-anim="walk">WALK (RETRO)</button>
          <button class="ro-btn-blue anim-btn" data-anim="run">RUN</button>
          <button class="ro-btn-blue anim-btn" data-anim="jump">JUMP</button>
          <button class="ro-btn-blue anim-btn" style="background:#ff4b4b" data-anim="stop">STOP ALL</button>
        </div>
    ...
    var init3D = () => {
      ...
      var animLoop = () => {
        ...
        if(currentAnim === "walk") {
          parts.larm.rotation.x = Math.sin(t * 8) * 0.5;
          parts.rarm.rotation.x = -Math.sin(t * 8) * 0.5;
          parts.lleg.rotation.x = -Math.sin(t * 8) * 0.5;
          parts.rleg.rotation.x = Math.sin(t * 8) * 0.5;
